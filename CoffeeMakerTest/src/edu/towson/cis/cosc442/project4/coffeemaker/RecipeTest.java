...
public class RecipeTest {
	...
	/**Test to compare  recipes with a name and one missing a name*/
	@Test
	public void testEqualsNoName() throws Exception{
	...
	/**Test to compare  recipes with a missing name and with a name*/
	@Test
	public void testEqualsNameMatch() throws Exception{
		Recipe r1 = new Recipe();
		Recipe r2 = new Recipe();
